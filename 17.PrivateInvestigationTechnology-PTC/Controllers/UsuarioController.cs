...
namespace _17.PrivateInvestigationTechnology_PTC.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RolId,Nombre")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RolId,Nombre")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
