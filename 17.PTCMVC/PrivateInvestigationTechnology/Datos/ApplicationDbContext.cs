...
namespace PrivateInvestigationTechnology.Datos
{
    ...
    public partial class ApplicationDbContext : DbContext
    {
        ...
        // Método OnConfiguring - se asegura de que la cadena de conexión se utilice desde la configuración
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Continúa con la configuración de las otras entidades...

            OnModelCreatingPartial(modelBuilder);
        }

        // Método parcial opcional para que puedas añadir configuraciones adicionales sin modificar este archivo
